...
/*	Register dma_gcr	*/
/*	 Fields dma_en	 */
#define PKTDMA_EN_WIDTH                                                          1
#define PKTDMA_EN_SHIFT                                                         31
#define PKTDMA_EN_MASK                                                  0x80000000
#define PKTDMA_EN_RD(src)                               (((src) & 0x80000000)>>31)
#define PKTDMA_EN_WR(src)                          (((u32)(src)<<31) & 0x80000000)
#define PKTDMA_EN_SET(dst,src) \
