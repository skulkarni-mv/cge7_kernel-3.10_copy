...
#define IND_ADDR_0_ADDR                 0x00000000
#define IND_COMMAND_0_ADDR              0x00000004
#define IND_WDATA_0_ADDR                0x00000008
#define IND_RDATA_0_ADDR                0x0000000c
#define IND_COMMAND_DONE_0_ADDR         0x00000010
 ...
 */
struct eth_rx_stat {
	u64 rx_byte_count;	/**< Receive Byte Counter */
	u64 rx_packet_count;	/**< Receive Packet Counter */
 ...
 */
struct eth_tx_stats {
	u64 tx_byte_count;		/**< Tx Byte cnt */
	u64 tx_packet_count;		/**< Tx pkt cnt */
...
struct apm_enet_priv {
	...
	void (*cle_bypass)(struct apm_enet_priv *priv, u32 dstqid, u32 fpsel, u32 nxtfpsel, bool bypass_en);
...
void apm_enet_cle_bypass(struct apm_enet_priv *priv, u32 dstqid,
		 u32 fpsel, u32 nxtfpsel, bool bypass_en);
