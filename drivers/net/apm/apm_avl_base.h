 ...
 * @param   node_index	Pointer to return the address where new node in AVL
 *			Tree gets added.
 * @return  APM_RC_OK or APM_RC_ERROR
 * @note    None
 */
int apm_cle_avl_add(u32 port, u32 *node_data, u32 *node_index);
 ...
 * @param   node_index	Pointer to return the address where the node in AVL
 *			Tree gets deleted.
 * @return  APM_RC_OK or APM_RC_ERROR
 * @note    None
 */
 ...
 * @param   node_index	Pointer to return the address of the matching node
 *			in Avl Tree.
 ...
 * @param   node_index	Address to write Avl Tree Node
 * @return  APM_RC_OK or APM_RC_ERROR
 * @note    This is used for debuging purpose only.
 */
int apm_cle_avl_wr(u32 port, u32 *node_data, u32 node_index);
 ...
 * @param   node_index	Address to read Avl Tree Node
 * @return  APM_RC_OK or APM_RC_ERROR
 * @note    This is used for debuging purpose only.
 */
int apm_cle_avl_rd(u32 port, u32 *node_data, u32 node_index);
