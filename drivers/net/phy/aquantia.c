...
#define AN_STATE			(MII_ADDR_C45 | 0x07 << 16 | 0x1)
...
static int aqr405_match_phy_device(struct phy_device *phydev)
{
	return (phydev->c45_ids.device_ids[1] & 0xfffffff0) == PHY_ID_AQR405;
}
...
},
{
	...
	.config_intr		= aqr105_config_intr,
	.did_interrupt		= aqr105_did_interrupt,
	.match_phy_device	= aqr405_match_phy_device,
	.driver			= {
		.owner = THIS_MODULE,
	},
},
