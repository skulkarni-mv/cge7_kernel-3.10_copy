/*
 * spi-xgene.h - AppliedMicro X-Gene SPI Driver Header File.
 ...
 * @file spi-xgene.h
 *
 * This file contains the SPI driver header for X-Gene SOCs of AppliedMicro Inc.
...
#define XGENE_COMPATIBLE_SPI_MODEBITS	(SPI_CPOL | SPI_CPHA | SPI_CS_HIGH | SPI_LSB_FIRST)

/** X-Gene settings */
/** Controller Signature */
#define XGENE_SPI_SIGNATURE			0xffffffff
/** FIFO depth of SPI controller */
#define XGENE_MAX_FIFO_DEPTH			256
/** Maximum number of slaves */
#define XGENE_CONFIG_MAX_SLAVE		3
/** Number of locations for fifo data register */
#define XGENE_DR_NUM_LOCATIONS 		40

/** XGENE control register default values */
#define XGENE_CTRL0_CFS_VAL			0x0 /**< Default value */
#define XGENE_CTRL0_SRL_VAL			0x0 /**< Default value */
#define XGENE_CTRL0_SLV_OE_VAL		0x0 /**< Default value */
#define XGENE_CTRL0_TMOD_TXRX_VAL      0x0 /**< Transmit & Receive mode */
#define XGENE_CTRL0_TMOD_TX_VAL		0x1 /**< Transmit only mode */
#define XGENE_CTRL0_TMOD_RX_VAL		0x2 /**< Receive only mode */
#define XGENE_CTRL0_TMOD_EEPROM_VAL  0x3 /**< EEPROM read mode */
#define XGENE_CTRL0_SCPOL_VAL		       0x0 /**< Polarity of serial clock */
#define XGENE_CTRL0_SCPH_VAL			0x0 /**< Phase of serial clock */
#define XGENE_CTRL0_FRF_VAL			0x0 /**< Motorola SPI frame format */
#define XGENE_CTRL0_DFS_VAL			0x7 /**< Data frame size (8 bits) */

/** X-Gene interrupt mask register value */
#define XGENE_IMR_VAL			0x0

/** X-Gene transmit FIFO size */
#define XGENE_TX_FIFO_SIZE			XGENE_MAX_FIFO_DEPTH

/** X-Gene transmit threshold value */
#define XGENE_TXFTLR_TFT_VAL			0xff

/** X-Gene receive FIFO size */
#define XGENE_RX_FIFO_SIZE			XGENE_MAX_FIFO_DEPTH

/** X-Gene receive threshold value */
#define XGENE_RXFTLR_RFT_VAL			0x0

/** X-Gene tunning delay count */
#define XGENE_TUNNING_DELAY		     0x10000

/** X-Gene SPI slave frequency */
#define XGENE_SPI_SPEED_HZ			4000000

struct xgene_spi_regs {
	u32 ctrlr0;
	u32 ctrlr1;
	u32 ssienr;
	u32 mwcr;
	...
	u8 dr[XGENE_DR_NUM_LOCATIONS*4];
}__attribute__ ((packed));

struct xgene_spi_controller_state {
	u8 activated;
	u8 mode;
	u8 chip_select;
	u8 bits_per_word;
...
struct xgene_spi_controller {
	...
	struct xgene_spi_regs __iomem *regs;
	unsigned int irq;
	...
	struct xgene_spi_controller_state state;
};

/*    Address of X-Gene Registers */
...
#define TFT_WIDTH                                                            8
#define TFT_SHIFT                                                             0
#define TFT_MASK                                                     0x000000ff
#define TFT_RD(src)                                      (((src) & 0x000000ff))
#define TFT_WR(src)                                 (((u32)(src)) & 0x000000ff)
#define TFT_SET(dst,src) (((dst) & ~0x000000ff) | (((u32)(src)) & 0x000000ff))

/*	Register RXFTLR	*/
/*	 Fields RFT	 */
#define RFT_WIDTH                                                            8
#define RFT_SHIFT                                                             0
#define RFT_MASK                                                     0x000000ff
#define RFT_RD(src)                                      (((src) & 0x000000ff))
#define RFT_WR(src)                                 (((u32)(src)) & 0x000000ff)
#define RFT_SET(dst,src) (((dst) & ~0x000000ff) | (((u32)(src)) & 0x000000ff))

/*	Register TXFLR	*/
/*	 Fields TXTFL	 */
#define TXTFL_WIDTH                                                          9
#define TXTFL_SHIFT                                                           0
#define TXTFL_MASK                                                   0x000001ff
#define TXTFL_RD(src)                                    (((src) & 0x000001ff))
#define TXTFL_SET(dst,src) \
                          (((dst) & ~0x000001ff) | (((u32)(src)) & 0x000001ff))

/*	Register RXFLR	*/
/*	 Fields RXTFL	 */
#define RXTFL_WIDTH                                                          9
#define RXTFL_SHIFT                                                           0
#define RXTFL_MASK                                                   0x000001ff
#define RXTFL_RD(src)                                    (((src) & 0x000001ff))
