...
#define caam_setbits32(_addr, _v) wr_reg32((_addr), rd_reg32(_addr) | (_v))
#define caam_clrbits32(_addr, _v) wr_reg32((_addr), rd_reg32(_addr) & ~(_v))

#endif /* CONFIG_ARM || CONFIG_ARM64 */

#ifndef CONFIG_64BIT
#if defined(__BIG_ENDIAN) && defined(CONFIG_PPC)

static inline void wr_reg64(u64 __iomem *reg, u64 data)
{
       unsigned long long mask1 = 0xffffffff00000000ull;
       unsigned long long mask2 = 0x00000000ffffffffull;
       wr_reg32((u32 __iomem *)reg, (data & mask1) >> 32);
       wr_reg32((u32 __iomem *)reg + 1, data & mask2);
}
