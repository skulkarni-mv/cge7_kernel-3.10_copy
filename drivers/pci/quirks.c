...
/*
 *  Xpliant XP80-A0 has class zero, suppressing resource allocation.
 *  Re-classify as something more appropriate
 */
static void quirk_cavium_xp80(struct pci_dev *dev)
{
	dev->class = PCI_CLASS_NETWORK_OTHER << 8;
}
DECLARE_PCI_FIXUP_EARLY(0x177d, 0xf000, quirk_cavium_xp80);
