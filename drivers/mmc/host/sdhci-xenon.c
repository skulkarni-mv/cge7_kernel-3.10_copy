...
static int sdhci_xenon_set_buswidth(struct sdhci_host *host, int width)
{
        u8 ctrl;
...
static int sdhci_xenon_set_uhs_signaling(struct sdhci_host *host, unsigned timing)
{
        u16 ctrl_2;
...
static struct sdhci_ops sdhci_xenon_ops = {
	.platform_bus_width	= sdhci_xenon_set_buswidth,
	.platform_reset_exit	= sdhci_xenon_reset,
