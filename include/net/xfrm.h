...
extern int xfrm_set_outbound_seq(struct xfrm_state *x, u32 seq, u32 seq_h);
extern int xfrm_set_inbound_seq(struct xfrm_state *x, u32 seq, u32 seq_h);
extern int xfrm_get_outbound_seq(struct xfrm_state *x, u32 *seq, u32 *seq_h, u32 *esn);
extern int xfrm_get_inbound_seq(struct xfrm_state *x, u32 *seq, u32 *seq_h, u32 *esn);
#endif
...
int xfrm_get_saddr(struct net *net, xfrm_address_t *local, xfrm_address_t *remote,
				unsigned short family);
#endif
#endif	/* _NET_XFRM_H */
