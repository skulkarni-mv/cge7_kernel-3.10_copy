...
extern void __setup_cpu_apm86xxx(unsigned long offset, struct cpu_spec *spec);
...
static struct cpu_spec __initdata cpu_specs[] = {
	...
	{ /* APM862xx */
		.pvr_mask               = 0xffffffff,
		.pvr_value              = 0x00a100a0,
		.cpu_name               = "APM862xx",
		.cpu_features           = CPU_FTRS_44X,
		.cpu_user_features      = COMMON_USER_BOOKE | PPC_FEATURE_HAS_FPU,
		.mmu_features           = MMU_FTR_TYPE_46x,
		.icache_bsize           = 32,
		.dcache_bsize           = 32,
		.cpu_setup              = __setup_cpu_apm86xxx,
		.machine_check          = machine_check_440A,
		.platform               = "ppc440",
	},
	{ /* APM867xx */
		.pvr_mask               = 0xffffffff,
		.pvr_value              = 0x00a16020,
		.cpu_name               = "APM867xx",
		.cpu_features           = CPU_FTRS_44X,
		.cpu_user_features      = COMMON_USER_BOOKE | PPC_FEATURE_HAS_FPU,
		.mmu_features           = MMU_FTR_TYPE_46x,
