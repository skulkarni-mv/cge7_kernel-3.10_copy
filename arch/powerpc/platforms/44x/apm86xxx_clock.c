...
static int apm_pka_trng_enable(struct clk *clk)
{
	static int call_count=0;
	if (!call_count++) 
		return apm_enable(clk);
	return 0;
}
...
static struct clk apm_rtc_clk = {
	...
	.reg_group = REG_GROUP_SRST1_CLKEN1,
	.clken_reg_off = SCU_CLKEN1_ADDR,
	.clken_mask = MPA_RTC1_F1_MASK, 
	.reset_reg_off = SCU_SRST1_ADDR,
	.reset_mask = MPA_RTC1_MASK,
};
#endif
...
static int apm_usb3_drd_apm_enable(struct clk *clk)
{
	struct apm86xxx_reset_ctrl reset_ctrl;

	apm_enable(&apm_usb_otg_clk);
	memset(&reset_ctrl, 0, sizeof(reset_ctrl));
	reset_ctrl.reg_group = clk->reg_group;
	reset_ctrl.clken_mask = clk->clken_mask;
	reset_ctrl.reset_mask = clk->reset_mask;
...
static int apm_usb3_host_enable(struct clk *clk)
{
	struct apm86xxx_reset_ctrl reset_ctrl;

	apm_enable(&apm_usb_host0_clk);
	memset(&reset_ctrl, 0, sizeof(reset_ctrl));
	reset_ctrl.reg_group = clk->reg_group;
	reset_ctrl.clken_mask = clk->clken_mask;
	reset_ctrl.reset_mask = clk->reset_mask;
...
static void apm_usb3_drd_apm_disable(struct clk *clk)
{
	struct apm86xxx_reset_ctrl reset_ctrl;

	apm_disable(&apm_usb_otg_clk);
	memset(&reset_ctrl, 0, sizeof(reset_ctrl));
	reset_ctrl.reset_type = ASSERT_RESET_FLAG;
	reset_ctrl.reg_group = clk->reg_group;
	reset_ctrl.clken_mask = clk->clken_mask;
...
static void apm_usb3_host_disable(struct clk *clk)

{
	struct apm86xxx_reset_ctrl reset_ctrl;

	apm_disable(&apm_usb_host0_clk);
	memset(&reset_ctrl, 0, sizeof(reset_ctrl));
	reset_ctrl.reset_type = ASSERT_RESET_FLAG;
	reset_ctrl.reg_group = clk->reg_group;
	reset_ctrl.clken_mask = clk->clken_mask;
...
static struct clk apm_usb3_drd_clk = {
	.con_id = "usb0_v3",
	.flags = CLK_HAS_CTRL,
	.parent = &apm_ahb_clk,
	.enable = apm_usb3_drd_apm_enable,
	.disable = apm_usb3_drd_apm_disable,
	.reg_group = REG_GROUP_SRST1_CLKEN1,
	.reset_reg_off = SCU_SRST1_ADDR,
	.reset_mask = USB0_PWR1_MASK|USB0_BUS1_MASK,
	.csr_reset_reg_off = SCU_CSR_SRST1_ADDR,
	.csr_reset_mask = USB01_MASK,
};

static struct clk apm_usb3_host_clk = {
	.con_id = "usb1_v3",
	.flags = CLK_HAS_CTRL,
	.parent = &apm_ahb_clk,
	.enable = apm_usb3_host_enable,
	.disable = apm_usb3_host_disable,
	.reg_group = REG_GROUP_SRST1_CLKEN1,
	.reset_reg_off = SCU_SRST1_ADDR,
	.reset_mask = USB1_PWR1_MASK|USB1_BUS1_MASK,
	.csr_reset_reg_off = SCU_CSR_SRST1_ADDR,
	.csr_reset_mask = USB11_MASK,
};
#endif
...
static void apm_hdlc_clk_calc(struct clk *clk)
{
	u32 freq;

	if (__apm86xxx_get_freq(APM86xxx_HDLC_FREQ, &freq) == 0) {
		clk->rate = freq;
	}
}
...
static struct clk apm_hdlc0_clk = {
	.con_id = "hdlc0",
	.flags = CLK_HAS_CTRL,
	.calc = apm_hdlc_clk_calc,
	.parent = &apm_ahb_clk,
	.enable = apm_enable,
	.disable = apm_disable,
	.reg_group = REG_GROUP_SRST1_CLKEN1,
	.clken_reg_off = SCU_CLKEN1_ADDR,
	.clken_mask = HDLC01_F1_MASK, 
	.reset_reg_off = SCU_SRST1_ADDR,
	.reset_mask = HDLC01_MASK,
};

static struct clk apm_hdlc1_clk = {
	.con_id = "hdlc1",
	.flags = CLK_HAS_CTRL,
	.calc = apm_hdlc_clk_calc,
	.parent = &apm_ahb_clk,
	...
	.reg_group = REG_GROUP_SRST1_CLKEN1,
	.clken_reg_off = SCU_CLKEN1_ADDR,
	.clken_mask = HDLC11_F1_MASK, 
	.reset_reg_off = SCU_SRST1_ADDR,
	.reset_mask = HDLC11_MASK,
};

static struct clk apm_tdm_clk = {
	.con_id = "tdm",
	.flags = CLK_HAS_CTRL,
	.enable = apm_enable,
	.disable = apm_disable,
	.reg_group = REG_GROUP_SRST_CLKEN,
	.clken_reg_off = SCU_CLKEN_ADDR,
	.clken_mask = TDM_F1_MASK,
	.reset_reg_off = SCU_SRST_ADDR,
	.reset_mask = TDM_MASK,
	.csr_reset_reg_off = SCU_CSR_SRST_ADDR,
	.csr_reset_mask = TDM_F2_MASK,
};
...
#if defined(CONFIG_APM867xx) || defined(CONFIG_APM866xx) || defined(CONFIG_APM862xxvB)
static struct clk apm_spi1_clk = {
	.con_id = "spi1",
	.flags = CLK_HAS_CTRL,
	.calc = apm_spi_clk_calc,
	.parent = &apm_apb_clk,
	...
	.reg_group = REG_GROUP_SRST_CLKEN,
	.clken_reg_off = SCU_CLKEN_ADDR,
	.clken_mask = SPI1_F1_MASK,
	.reset_reg_off = SCU_SRST_ADDR,
	.reset_mask = SPI1_MASK,
};
#endif /* CONFIG_APM867xx || defined(CONFIG_APM866xx) || defined(CONFIG_APM862xxvB) */
