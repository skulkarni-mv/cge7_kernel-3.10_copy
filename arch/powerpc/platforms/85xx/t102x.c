 ...
 */
static int __init t102x_probe(void)
{
...
machine_arch_initcall(t102x, corenet_ds_publish_devices);

#ifdef CONFIG_SWIOTLB
machine_arch_initcall(t102x, swiotlb_setup_bus_notifier);
#endif
