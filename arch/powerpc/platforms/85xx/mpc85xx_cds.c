...
static irqreturn_t mpc85xx_cds_8259_cascade_handler(int irq, void *unused)
{
...
static irqreturn_t mpc85xx_cds_8259_cascade_thread_fn(int irq, void *unused)
{
	return IRQ_NONE;
}

static struct irqaction mpc85xx_cds_8259_irqaction = {
	.handler = mpc85xx_cds_8259_cascade_handler,
	.thread_fn = mpc85xx_cds_8259_cascade_thread_fn,
	.flags = IRQF_SHARED,
	.name = "8259 cascade",
	.dev_id = &mpc85xx_cds_8259_irqaction, /* unused but must be non-zero */
};
...
static int mpc85xx_cds_8259_attach(void)
{
	...
	ret = setup_irq(cascade_irq, &mpc85xx_cds_8259_irqaction);
	if (unlikely(ret)) {
...
machine_arch_initcall(mpc85xx_cds, mpc85xx_cds_8259_attach);
