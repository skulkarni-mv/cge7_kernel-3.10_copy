 ...
 *
 * This module defines the interface between iPP and PowerPC.
 *
 */
...
#define IPP_FW_MAJOR_VER_NO	1
#elif defined(CONFIG_APM867xx)
#define IPP_FW_MAJOR_VER_NO	2
#else
#define IPP_FW_MAJOR_VER_NO	3
#endif
#define PPC_CORE0		0 	/**< PPC Core 0 ID */
#define PPC_CORE1		1 	/**< PPC Core 1 ID */
#if defined(CONFIG_APM862xx) || defined(CONFIG_APM862xxvB) || defined(CONFIG_APM866xx)
#define MAX_PPC_CORES		2 	/**< Maximum number of PPC cores */
#define MAX_PPC_CORES_MASK	3 	/**< BitMask for max PPC cores */
#else
#define MAX_PPC_CORES		1 	/**< Maximum number of PPC cores */
#define MAX_PPC_CORES_MASK	1 	/**< BitMask for max PPC cores */
#endif
/*@}*/
...
struct ipp_dp_qm_cmd  
{
	/* As this is spec from SlimPRO, the format is in little endian */
#if defined(__PPC__)
	unsigned int rd : 8;			/* Read (1) or write (0) */
...
#define IPP_DP_CMD_CLR_VIOLATION 	0x05 /* Clear read/write violation */
#define IPP_DP_CMD_REQ_IRQ	 	0x06 /* Request IRQ */
#define IPP_DP_CMD_CLR_MEMSHUTDOWN 	0x07 /* Release memory from shutdown */
#define IPP_DP_CMD_REG_WR		0x08 /* Register write */
#define IPP_DP_CMD_QM_PB		0x09 /* QM read/write PBN */
#define IPP_DP_CMD_QM_QSTATE		0x0A /* QM read/write queue state */
#define IPP_DP_CMD_QM_CSTATE		0x0B /* QM read/write TM queue state */

#define IPP_DP_RES_NONE			0x00
#define IPP_DP_RES_SLIMPRO		0x01
#define IPP_DP_RES_MEMC			0x02 /* MemC CSR, MailBox */
#define IPP_DP_RES_AHBC			0x03
#define IPP_DP_RES_DDR			0x04
#define IPP_DP_RES_SDU			0x05 /* Also for MPIC/LCD */
#define IPP_DP_RES_PCIE0		0x06
#define IPP_DP_RES_PCIE1		0x07
#define IPP_DP_RES_PCIE2		0x08
#define IPP_DP_RES_SATA			0x09
#define IPP_DP_RES_QM			0x0A
#define IPP_DP_RES_PBRG			0x0B
#define IPP_DP_RES_TOTAL		0x0C

#define IPP_DP_RES_DMA			0x0C	/* Not available yet */
#define IPP_DP_RES_SEC			0x0D
#define IPP_DP_RES_OCM			0x0E
#define IPP_DP_RES_ETH01		0x0F
#define IPP_DP_RES_QML			0x10
#define IPP_DP_RES_ETH23		0x11
#define IPP_DP_RES_CLE23		0x12
...
enum ipp_error_codes {
	...
	IPP_DP_ERR_RES_TYPE_INVALID, 	/* Resource type out of range */
	IPP_DP_ERR_RES_PROTECTIVE,	/* Resource type protective mode */
	IPP_DP_ERR_RES_EXCLUSIVE,	/* Resource type exclusive mode */ 
	IPP_DP_ERR_RES_SHARED,		/* Resource type shared mode */
	IPP_DP_ERR_RES_OUTOFENTRY,	/* Out of resource entry */
	IPP_DP_ERR_NORESOURCE,		/* No such resource */
	IPP_DP_ERR_OUTOFRANGE,		/* PHY address out of range */
};
...
enum ipp_addr_message_handlers {
	...
	IPP_DP_ADDR_HDLR=4, 		/**< AMP domain protection handler */
...
enum ipp_regbank_id {
	...
	IPP_REGBANK_RTC=5, /**< RTC Register Bank */
...
enum ipp_ppcboot_devices {
	...
	IPP_PPCBOOTDEV_SDIO=0, /**< PPC boot device SDIO */
#else
	IPP_PPCBOOTDEV_NAND=0, /**< PPC boot device NAND */
#endif
	IPP_PPCBOOTDEV_NOR=1, /**< PPC boot device NOR */
	IPP_PPCBOOTDEV_LEGACY_NAND=2, /**< PPC boot device Legacy-NAND */
	IPP_PPCBOOTDEV_LEGACY_NOR=3, /**< PPC boot device Legacy-NOR */
	IPP_PPCBOOTDEV_NAND_ECC=4, /**< PPC boot device NAND-ECC */
	IPP_PPCBOOTDEV_USB=5,	/**< PPC boot device USB */
#if defined(CONFIG_APM866xx) || defined(CONFIG_APM862xxvB)
	IPP_PPCBOOTDEV_SPI=6, /**< PPC boot device SPI */
#else
	IPP_PPCBOOTDEV_SDIO=6, /**< PPC boot device SDIO */
	IPP_PPCBOOTDEV_SPI=7, /**< PPC boot device SPI */
#endif
	IPP_PPCBOOTDEV_SATA=8, /**< PPC boot device SATA */
	IPP_PPCBOOTDEV_PCIE=9, /**< PPC boot device PCIe */
	IPP_PPCBOOTDEV_NORMUX=0xA, /**< PPC boot device NOR MUX mode */
	IPP_PPCBOOTDEV_SD_EXT=0xB, /**< PPC boot device SD using external ipp */
	IPP_PPCBOOTDEV_SPI_USB_EXT=0xC, /**< PPC boot device SPI/USB using external IPP */
#if defined(IPP_USE_SPI)
	IPP_PPCBOOTDEV_SPI_EXT=0xC, /**< PPC boot device SPI using external ipp */
#elif defined(IPP_USE_USB)
	IPP_PPCBOOTDEV_USB_EXT=0xC, /**< PPC boot device USB using external ipp */
#endif
	IPP_PPCBOOTDEV_SATA_EXT=0xD, /**< PPC boot device SATA using external ipp */
