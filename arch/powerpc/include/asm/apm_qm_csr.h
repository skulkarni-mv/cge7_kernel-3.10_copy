...
#define INIT_F2_WR 		INIT_WR
#define QNUMBER_F2_SET 		QNUMBER_SET
#define ENABLE_F6_SET 		QM_ENABLE_SET
#define QID_ENQ_COUNTER_F2_RD	QID_ENQ_COUNTER_RD
#define QID_ENQ_COUNTER_F2_WR	QID_ENQ_COUNTER_WR
#define QID_ENQ_COUNTER_F2_SET	QID_ENQ_COUNTER_SET
#define QID_DEQ_COUNTER_F2_RD	QID_DEQ_COUNTER_RD
#define QID_DEQ_COUNTER_F2_WR	QID_DEQ_COUNTER_WR
#define QID_DEQ_COUNTER_F2_SET	QID_DEQ_COUNTER_SET
