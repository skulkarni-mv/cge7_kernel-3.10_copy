...
void read_inventory_mac(struct memory_accessor *a, void *context)
{
    int read_bytes = 0;
    int write_bytes = 0;
    int write = 0;
    ...
    read_bytes = a->read(a, (char *)&eeprom_device_mac, 0x0, sizeof(eeprom_device_mac_t));
...
write_def_config:
    if (write)
    {
        ...
        write_bytes = a->write(a, (char *)&eeprom_device_mac, 0x0, sizeof(eeprom_device_mac_t));
        mdelay(10);
    }
