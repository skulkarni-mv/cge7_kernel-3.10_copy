...
static struct i2c_board_info __initdata scmb_i2c_info[] = {
    {
...
static const char *puma1_boards_compat_dt[] __initdata = {
		"ericsson,puma1",
		NULL,
};
...
static void __init puma1_gt_init(void)
{
